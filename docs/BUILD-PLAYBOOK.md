...
**20.** `JackpotKit/Package.swift` — add to `products:` and `targets:`
...
**25.** `JackpotKit/Sources/JackpotFormsDomain/FormSubmitResult.swift`
...
**26.** `JackpotKit/Sources/JackpotFormsDomain/PasswordPolicy.swift`
...
**27.** `JackpotKit/Sources/JackpotFormsDomain/RegexResolving.swift`
...
**28.** `JackpotKit/Sources/JackpotFormsDomain/FieldValidator.swift`
...
**29.** `JackpotKit/Sources/JackpotFormsDomain/FormLoadError.swift`
...
**30.** `JackpotKit/Sources/JackpotFormsDomain/FormLocalizing.swift`
...
**31.** `JackpotKit/Sources/JackpotFormsDomain/FormRepository.swift`
...
**32.** `JackpotKit/Sources/JackpotFormsData/FormDTO.swift`
...
**33.** `JackpotKit/Sources/JackpotFormsData/FormMapper.swift`
...
**34.** `JackpotKit/Sources/JackpotFormsData/StubFormRepository.swift`
...
**36.** `JackpotKit/Sources/JackpotFormsUI/FormDependencies.swift`
...
**37.** `JackpotKit/Sources/JackpotFormsUI/DynamicFormModel.swift`
...
**40.** `JackpotKit/Sources/JackpotFormsUI/Fields/InputFieldView.swift`
...
**41.** `JackpotKit/Sources/JackpotFormsUI/Fields/DropdownFieldView.swift`
...
**42.** `JackpotKit/Sources/JackpotFormsUI/Fields/DateFieldView.swift`
...
**45.** `JackpotKit/Sources/JackpotFormsUI/Demo/PreviewSupport.swift`
...
**46.** `JackpotKit/Sources/JackpotFormsUI/Demo/FormSandboxView.swift`
...
**47.** `JackpotKit/Tests/JackpotFormsTests/FormDecodingTests.swift`
...
**48.** `JackpotKit/Tests/JackpotFormsTests/FieldValidatorTests.swift`
...
**49.** `JackpotKit/Tests/JackpotFormsTests/DynamicFormModelTests.swift`
...
`JackpotFormsTests: Executed 49 tests, with 0 failures`
...
**52.** `JackpotKit/Package.swift` — add to `products:` and `targets:`
...
**53.** `JackpotKit/Sources/JackpotNetworking/HTTPMethod.swift`
...
**54.** `JackpotKit/Sources/JackpotNetworking/HTTPClient.swift`
...
**55.** `JackpotKit/Sources/JackpotNetworking/APIEnvironment.swift`
...
**56.** `JackpotKit/Sources/JackpotNetworking/APIEndpoint.swift`
...
**57.** `JackpotKit/Sources/JackpotNetworking/APIError.swift`
...
**58.** `JackpotKit/Sources/JackpotNetworking/RequestInterceptor.swift`
...
**60.** `JackpotKit/Tests/JackpotNetworkingTests/MockHTTPClient.swift`
...
**61.** `JackpotKit/Tests/JackpotNetworkingTests/APIEndpointTests.swift`
...
**62.** `JackpotKit/Tests/JackpotNetworkingTests/APIProblemTests.swift`
...
**63.** `JackpotKit/Tests/JackpotNetworkingTests/RemoteApiClientTests.swift`
...
**65.** `JackpotKit/Sources/JackpotLocalization/Translations.swift`
...
**66.** `JackpotKit/Sources/JackpotFormsRemote/CRMEnvironment.swift`
...
**67.** `JackpotKit/Sources/JackpotFormsRemote/FormEndpoints.swift`
...
**68.** `JackpotKit/Sources/JackpotFormsRemote/FormErrorMapper.swift`
...
**69.** `JackpotKit/Sources/JackpotFormsRemote/RemoteFormRepository.swift`
...
**70.** `JackpotKit/Sources/JackpotForms/TranslationsLocalizer.swift`
...
**71.** `JackpotKit/Sources/JackpotForms/JackpotForms.swift`
...
**72.** `JackpotKit/Sources/JackpotForms/Previews.swift`
...
**73.** `JackpotKit/Tests/JackpotLocalizationTests/TranslationsTests.swift`
...
**74.** `JackpotKit/Tests/JackpotFormsTests/FormErrorMappingTests.swift`
...
**75.** `JackpotKit/Tests/JackpotFormsTests/FormRepositoryTests.swift`
...
**78.** `JackpotKit/Package.swift` — add to `products:` and `targets:`
...
**79.** `JackpotKit/Sources/JackpotRegistration/RegistrationService.swift`
...
**81.** `JackpotKit/Sources/JackpotRegistration/RegistrationPanelController.swift`
...
**82.** `JackpotKit/Sources/JackpotRegistration/Previews.swift`
...
**83.** `JackpotKit/Tests/JackpotRegistrationTests/RegistrationServiceTests.swift`
